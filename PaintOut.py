...
def paint_dim_1_4():
    ...
    sub1.plot(x, [0.7037, 0.7442, 0.7558, 0.7671], '^-' ,color='coral', label=r'BERT_CNN4Rec@20M', lw=lw, markersize=markersize)
    sub1.plot(x, [0.6818, 0.7180, 0.7499, 0.7588], 's-' ,color='green', label=r'BERT4Rec@20M', lw=lw, markersize=markersize)
    sub1.plot(x, [0.7029, 0.7476, 0.7684, 0.7594], '^--',color='coral', label=r'BERT_CNN4Rec@1M', lw=lw, markersize=markersize)
    ...
    sub3.plot(x, [0.4523, 0.4926, 0.5073, 0.5216], '^-', color='coral', label=r'BERT_CNN4Rec@20M', lw=lw, markersize=markersize)
    sub3.plot(x, [0.4291, 0.4633, 0.5005, 0.5142], 's-', color='green', label=r'BERT4Rec@20M', lw=lw, markersize=markersize)
    sub3.plot(x, [0.4784, 0.5286, 0.5457, 0.5393], '^--',color='coral',  label=r'BERT_CNN4Rec@1M', lw=lw, markersize=markersize)
...
def paint_top_1_4():
    ...
    # 创建子图1
    sub1 = fig.add_subplot(1, 2, 1)
    sub1.plot(x, [0.6058, 0.7442, 0.8113, 0.8532, 0.8812], '^-', color='coral', label=r'BERT_CNN4Rec@20M', lw=lw, markersize=markersize)
    sub1.plot(x, [0.5740, 0.7180, 0.7909, 0.8367, 0.8676], 's-', color='green', label=r'BERT4Rec@20M', lw=lw, markersize=markersize)
    sub1.plot(x, [0.6336, 0.7476, 0.8108, 0.8519, 0.8848], '^--',color='coral',  label=r'BERT_CNN4Rec@1M', lw=lw, markersize=markersize)
    ...
    # 创建子图2
    sub3 = fig.add_subplot(1, 2, 2)
    sub3.plot(x, [0.4477, 0.4926, 0.5104, 0.5203, 0.5265], '^-', color='coral', label=r'BERT_CNN4Rec@20M', lw=lw, markersize=markersize)
    sub3.plot(x, [0.4166, 0.4633, 0.4827, 0.4935, 0.5002], 's-', color='green', label=r'BERT4Rec@20M', lw=lw, markersize=markersize)
    sub3.plot(x, [0.4917, 0.5286, 0.5454, 0.5551, 0.5623], '^--',color='coral',  label=r'BERT_CNN4Rec@1M', lw=lw, markersize=markersize)
