...
def get_E():
    ...
    # trainer.train()
    best_model = torch.load(os.path.join('/home/deipss/BERT4Rec-VAE-Pytorch-master/experiments/test_bert_128_ml-1m_2021-05-11_0_meta/models/best_acc_model.pth')).get('model_state_dict')
